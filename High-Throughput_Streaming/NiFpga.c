...
static NiFpga_Status (NiFpga_CCall *NiFpga_configureFifoBuffer)(
                                   NiFpga_Session session,
                                   uint32_t       fifo,
                                   uint64_t       address,
                                   size_t         depth,
                                   size_t*        actualDepthOut,
                                   uint32_t       dmaBufferType) = NULL;

NiFpga_Status NiFpga_ConfigureFifoBuffer(NiFpga_Session session,
                                         uint32_t       fifo,
                                         uint64_t       address,
                                         size_t         depth,
                                         size_t*        actualDepthOut,
                                         uint32_t       dmaBufferType)
{
   return NiFpga_configureFifoBuffer
        ? NiFpga_configureFifoBuffer(session, fifo, address, depth, actualDepthOut, dmaBufferType)
        : NiFpga_Status_ResourceNotInitialized;
}
...
} NiFpga_functions[] =
{
   ...
   {"NiFpgaDll_ConfigureFifoBuffer", (NiFpga_FunctionPointer*)&NiFpga_configureFifoBuffer},
